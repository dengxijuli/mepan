...
import com.mepan.utils.VerifyUtils;
...
public class GlobalOperationAspect {
    ...
    @Pointcut("@annotation(com.mepan.annotation.GlobalInterceptor)")
    ...
    private void checkLogin(Boolean checkAdmin) {
        ...
        if (sessionUser == null && appConfig.getDev() != null && appConfig.getDev()) {
            List<UserInfo> userInfoList = iuserInfoService.findListByParam(new UserInfoQuery());
