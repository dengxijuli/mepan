...
import com.mepan.entity.dto.CreateImageCode;
...
public class AccountController extends ABaseController {
    private static final Logger logger = LoggerFactory.getLogger(com.mepan.controller.AccountController.class);
    ...
    public ResponseVO register(HttpSession session,
        ...
        try {
            ...
            iUserInfoService.register(email, nickName, password, emailCode);
            return getSuccessResponseVO(null);
        } finally {
    ...
    public ResponseVO updateUserAvatar(HttpSession session, MultipartFile avatar) {
        ...
        iUserInfoService.update(userInfo, new QueryWrapper<UserInfo>().eq("user_id", webUserDto.getUserId()));
    ...
    public ResponseVO updatePassword(HttpSession session,
        ...
        iUserInfoService.update(userInfo, new QueryWrapper<UserInfo>().eq("user_id", sessionWebUserDto.getUserId()));
        return getSuccessResponseVO(null);
    }
    ...
    public ResponseVO qqLoginCallback(HttpSession session,
        ...
        SessionWebUserDto sessionWebUserDto = iUserInfoService.qqLogin(code);
        session.setAttribute(Constants.SESSION_KEY, sessionWebUserDto);
