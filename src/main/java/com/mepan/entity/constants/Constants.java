package com.mepan.entity.constants;
...
public class Constants {
    ...
    public static final String REDIS_KEY_DOWNLOAD = "mepan:download:";

    public static final String REDIS_KEY_SYS_SETTING = "mepan:syssetting:";

    public static final String REDIS_KEY_USER_SPACE_USE = "mepan:user:spaceuse:";

    public static final String REDIS_KEY_USER_FILE_TEMP_SIZE = "mepan:user:file:temp:";
